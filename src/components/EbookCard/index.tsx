      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.desc}>
            Coding bootcamps teach you to code — but they don't always teach you
            how to actually get hired. This guide fills in the gaps: how to
            navigate the job search, stand out as a career changer, and use your
            bootcamp to its fullest potential.
          </p>
          ...
          <p className={styles.oop}>
            Currently out of print — but if you're curious, feel free to reach
